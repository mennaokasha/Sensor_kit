...
myApp.RegCounter_win = Ti.UI.createWindow(myApp.win_specs);
myApp.RegCounterVer_view = Ti.UI.createView(myApp.verticalViewSpecs);
	
		//*****************create button
		myApp.RegCounter_btn=Ti.UI.createButton(myApp.button_specs);
		myApp.RegCounter_btn.title="Register Your counter";
		myApp.RegCounterVer_view.add(myApp.RegCounter_btn);
		/*************Add components*******/
		myApp.RegCounterVer_view.add(myApp.RegCounter_btn);
		myApp.RegCounter_win.add(myApp.RegCounterVer_view);
/*******Open main window****/
myApp.RegCounter_win.open();
/*************************Add Event Listener to Reg Sensor*************/
myApp.RegCounter_btn.addEventListener('click',function(e){
